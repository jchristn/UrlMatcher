...
namespace UrlMatcher
{
    ...
    public class Matcher
    {
        ...
        /// It's really boring, but if you want to see it, assign Console.WriteLine to it.
        /// </summary>
        ...
        public bool Match(string url, string pattern, out Dictionary<string, string> vals)
        {
            vals = null;
